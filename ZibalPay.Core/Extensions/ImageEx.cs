...
namespace ZibalPay.Core.Extensions
{
    public static class ImageEx
    {
        public static string SaveImage(this IFormFile imgfile, string filename, string path, string thumbPath)
        {
            filename = filename + Path.GetExtension(imgfile.FileName);
            ...
            {
                thumbPath = Path.Combine(Directory.GetCurrentDirectory(), thumbPath, filename);
                Image_resize_Scale(path, thumbPath, 350);
            }
        ...
        public static void Image_resize_Scale(string input_Image_Path, string output_Image_Path, int new_Width)
        {
